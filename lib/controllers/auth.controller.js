...
export async function login(req, res, next) {
    try {
        ...
        const foundUser = await UserModel.findOrFail({
            username,
            deletedAt: null,
        })
        ...
        const duration = saveLogin
            ? process.env.TOKEN_DURATION_SAVED
...
export async function logout(req, res, next) {
    try {
        ...
        await AccessTokenModel.updateOne({ owner: id }, { isActive: false })
